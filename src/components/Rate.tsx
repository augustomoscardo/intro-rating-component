...
export function Rate({ handleSubmit }: RateProps) {
  ...
  return (
    <div className="bg-blue-800 sm:max-w-[360px] max-w-[400px] h-[400px] w-full flex flex-col items-start sm:p-7 p-6 rounded-3xl">
      <img
      ...
      <div>
        <h3 className="text-gray-100 text-3xl font-bold mb-3">
          How did we do?
        </h3>
